...
export default function Home() {
  ...
  return (
    <>
      ...
      <Container className="p-28 flex flex-col justify-center items-center gap-10">
        <Image src={"/images/zeniark-logo.png"} width={344} height={91} alt="Zeniark Logo" />

        <div>
          <h1 className="font-semibold text-4xl leading-[3.25rem]">
            Welcome to the Trivia Challenge!
          </h1>
          <p className="text-[1.375rem] leading-8 text-center mb-10">
            You will be presented with 10 True or False questions.
          </p>

          <p className="text-4xl text-center text-white px-20 py-4 rounded-2xl bg-primary font-medium">
            Can you score 10/10?
          </p>
        </div>
