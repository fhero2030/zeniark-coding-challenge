...
export default function Home() {
  ...
  return (
    <>
      ...
      <Container className="p-14 md:p-28 flex flex-col justify-center items-center gap-10">
        <Image src={"/images/zeniark-logo.png"} width={344} height={91} alt="Zeniark Logo" />

        <div>
          <h1 className="font-semibold text-center text-3xl md:text-4xl leading-[3.25rem]">
